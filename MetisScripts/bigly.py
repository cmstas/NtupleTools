...
def get_master_list():
    ...
    # Two PDs needed to be reprocessed, so we replace them here
    dataset_names = ",".join(dataset_names).replace("/JetHT/Run2016B-17Jul2018_ver2-v1/MINIAOD","/JetHT/Run2016B-17Jul2018_ver2-v2/MINIAOD") \
            .replace("/MET/Run2016H-17Jul2018-v1/MINIAOD","/MET/Run2016H-17Jul2018-v2/MINIAOD").split(",")
...
if __name__ == "__main__":
    ...
    for i in range(10000):
        ...
        for campaign in ["mc_2018_102x_v1", "mc_2017_94x_v2"]:
