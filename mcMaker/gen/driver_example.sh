...
scram b
cd ../../
cmsDriver.py Configuration/GenProduction/python/SUS-RunIISummer15GS-00059-fragment.py --filein "file:/hadoop/cms/store/user/namin/lhe_Mar9/T5qqqqWH_mGl-1400_mLSP-1_mChi-700_seed11218.lhe" --fileout file:GENSIM.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename pset_gensim.py --no_exec -n 240;
